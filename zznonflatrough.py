# python test.py -d zznonflatrough.py -o ./testresults/nonflattilt/ --mgtype pfas --numlevels 5 --rtol 1e-12 --eps 1e-3 --maxiters 50 --atol 1e-20 --innerits 1 --fmg true --fmgc 2
...
gc = 9.81 #m / s^2
A = 10**(-16) #Pa^-3 a^-1
a = 750 #parameter controlling the periodicity of the bed and hence the roughness. a = 750 is fairly smooth
