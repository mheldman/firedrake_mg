# python test.py -d zzpbueler.py -o ./testresults/ --mgtype gmg --fmg true --fmgc 2 --numlevels 6 --rtol 1e-12 --eps 0.0 --maxiters 10000
...
def D(u):
  return (inner(grad(u), grad(u)) + eps**2)**((p - 2.)/2.)
