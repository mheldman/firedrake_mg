...
def build_levels(numlevels):
  ...
  for mesh in mh:
    ...
    lvl = licplevel(mesh, V, a, b, A, B, bcs, H, findices=None, M=M, bindices=bndry,bvals=bvals)
    if z > 0:
