# python test.py -d zznonflat.py -o ./testresults/nonflattilt/ --mgtype pfas --numlevels 5 --rtol 1e-12 --maxiters 50 --atol 1e-20 --innerits 1 --fmg true --fmgc 2 --cycle V --preiters 2 --postiters 2
...
/Users/maxheldman/firedrakegmg/zznonflat.py
p  = 4
q  = p + 1
H0 = 3 #km
R  = 750 #km
